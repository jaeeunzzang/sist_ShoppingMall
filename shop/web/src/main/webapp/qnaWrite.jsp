								...
								<div class="table-responsive">
									<table class="table table-bordered">
										...
										<tr>
											...
											<td>
												<form role="form" class="form-inline" action="/web/qnaInsert.do" id="newFrm">
								...
								<div class="table-responsive">
									<table class="table table-bordered">
										...
										<tr>
											<td class="text-center">제목</td>
											<td>
												<form role="form" class="form-inline" action="/web/qnaUpdate.do" id="modFrm">
													<div class="form-group">
														<input type="text" class="form-control" name="q_title" placeholder="제목을 입력해주세요"
