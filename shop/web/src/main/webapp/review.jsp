							...
							<div class="row">
								<div class="col-xs-3 col-md-3">
									<div class="thumbnail best">
										<a class="fancybox" rel="gallery1" href="#"> <img src="img/coat.jpg">
										</a>
										<div class="caption">
											<h5>마음에 쏙 들어요!</h5>
											<p>
								...
								<div class="col-xs-3 col-md-3">
									<div class="thumbnail best">
										<a class="fancybox" rel="gallery1" href="#"> <img src="img/trouser.jpg">
										</a>
										<div class="caption">
											<h5>소재가 완전 고급스러워요~</h5>
											<p>
								...
								<div class="col-xs-3 col-md-3">
									<div class="thumbnail best">
										<a class="fancybox" rel="gallery1" href="#"> <img src="img/skirt.jpg">
										</a>
										<div class="caption">
								...
								<div class="col-xs-3 col-md-3">
									<div class="thumbnail best">
										<a class="fancybox" rel="gallery1" href="#"> <img src="img/e.jpg">
										</a>
										<div class="caption">
											<h5>편하고 좋아요</h5>
											<p>
				...
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							...
							<th class="text-center"><img src="img/coat.jpg" /></th>
							<th>마음에 쏙 들어요!</th>
