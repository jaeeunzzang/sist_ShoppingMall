					...
					<div class="panel-body">
						<div class="table-responsive">
							...
							<colgroup>
								...
								<tr>
									<td colspan="2"><textarea rows="12" class="form-control">총장이 어떻게 되나요?</textarea></td>
								</tr>
								<tr>
						...
						<form role="form" class="form-inline pull-right">
							<a href="qnaModify.jsp"><button type="button" class="btn btn-default btn-s">수정</button></a>
