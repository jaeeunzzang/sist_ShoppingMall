 ...
 * Generated at: 2020-11-26 07:39:35 UTC
...
public final class adminPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<a href=\"userManegement.jsp\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"card-body text-center\" style=\"margin: 30px\">\n");
      ...
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-4\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"productManegement1.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"card\" style=\"width: 350px; height: 200px; border: 1px black solid;\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"card-header text-center\">\n");
      ...
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-4\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"productManegement2.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"card\" style=\"width: 350px; height: 200px; border: 1px black solid;\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"card-header text-center\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<h3>BOARD</h3>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"card-body text-center\" style=\"margin: 30px\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<h4>재고관리</h4>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"card-footer text-center\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<h1>\n");
