 ...
 * Generated at: 2020-12-07 15:12:38 UTC
...
public final class reviewWrite_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t.click(\r\n");
      out.write("\t\t\t\t\t\tfunction() {\r\n");
      out.write("\t\t\t\t\t\t\tif ($(\"input[name='r_title']\").val().length < 1\r\n");
      out.write("\t\t\t\t\t\t\t\t\t|| $(\"textarea[name='r_contents']\").val().length < 1) {\r\n");
      out.write("\t\t\t\t\t\t\t\talert(\"제목과 내용을 입력해주세요\");\r\n");
      out.write("\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t$(\"form[name='newFrm']\").submit();\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t$(\"form[name='modFrm']\").submit();\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /reviewWrite.jsp(54,8) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fwhen_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t<form action=\"reviewInsert.do\" enctype=\"multipart/form-data\" method=\"post\" name=\"newFrm\">\r\n");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"form-control\" placeholder=\"제목을 입력해주세요\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"r_title\"> <input type=\"hidden\" name=\"p_no\" value=\"");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\"><textarea rows=\"12\" class=\"form-control\" placeholder=\"내용을 입력해주세요\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"r_contents\"></textarea></td>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">첨부파일</td>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"file\" name=\"file\"><font color=\"red\">파일은 한번 올리면 바꾸실\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t수 없습니다.</font></td>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t</table>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t</form>\r\n");
          out.write("\t\t\t\t\t\t</div>\r\n");
          ...
          out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default btn-s\" onclick=\"location.href='reviewList.do'\">목록</button>\r\n");
          out.write("\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fotherwise_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_c_005fotherwise_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t<form action=\"reviewUpdate.do\" enctype=\"multipart/form-data\" method=\"post\" name=\"modFrm\">\r\n");
          out.write("\t\t\t\t\t\t\t\t<table class=\"table table-bordered\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t<colgroup>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<col width=\"100\" />\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<col width=\"900\" />\r\n");
          ...
          out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">제목</td>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"form-control\" name=\"r_title\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${reviewInfo.p_no}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("\"><input type=\"hidden\" name=\"r_no\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
          ...
          out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\"><textarea rows=\"12\" class=\"form-control\" name=\"r_contents\">");
