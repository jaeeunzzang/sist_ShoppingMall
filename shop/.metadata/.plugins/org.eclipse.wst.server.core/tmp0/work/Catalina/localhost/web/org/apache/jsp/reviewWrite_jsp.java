 ...
 * Generated at: 2020-11-25 09:17:41 UTC
...
public final class reviewWrite_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td>\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t        \t\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"제목을 입력해주세요\">\t\t    \t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td class=\"text-center\" >이름</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"이름을 입력해주세요\" style=\"width: 160px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<a href=\"#\"><button type=\"button\" class=\"btn btn-default btn-s\">수정</button></a>\r\n");
